...
import static org.eclipse.che.plugin.machine.artik.replication.shell.JsonValueHelper.REPLICATION_ROOT;
...
public class JsonValueHelperTest {
    ...
    public void shouldProvideCorrectJsonElementValues() throws ServerException {
        ...
        assertEquals(jsonValueHelper.getReplicationRoot(), REPLICATION_ROOT);
