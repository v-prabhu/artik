...
public class PushToDeviceServiceTest {
    ...
    private static final String SOURCE_PATH_PARAM_NAME = "source_path";
    ...
    public void shouldCallPtdManagerAndRespondWithOkStatus() throws ServerException, IOException, JsonParseException {
        ...
        verify(replicationManager, times(1)).copy(MACHINE_ID_PARAM_VALUE, SOURCE_PATH_PARAM_VALUE, TARGET_PATH_PARAM_VALUE);
    }
}
