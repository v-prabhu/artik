...
/**
 * Action to turn on production mode at Artik device.
 *
 * @author Vitaliy Guliy
 */
public class TurnProductionModeAction extends AbstractPerspectiveAction {

    private final DevelopmentModeManager    developmentModeManager;
    private final String                    machineName;

    @Inject
    public TurnProductionModeAction(ArtikLocalizationConstant locale,
    ...
    public void actionPerformed(ActionEvent event) {
        developmentModeManager.turnOnProductionMode(machineName);
    }
